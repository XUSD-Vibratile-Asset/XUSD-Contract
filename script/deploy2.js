...
async function deployRouter() {
 ...
 let provider = new ethers.JsonRpcProvider(`https://rpc.pulsechain.com`);
  ...
  const Token = await ethers.getContractFactory('VibeRegistry', {
    libraries: {
      AtropaMath: '0x0Af2D009B948Ce99F00C3BC005BdE5cB22e6F871',
      VibeLibRegistry:'0xe684ADC09a81c4b92efC9BCe687b0B53062e49d2',
    },
  });
//     let mooo = {
...
// const t  = await Token.deploy('0xdB117EE426EA72A4A16Bc1f6a791bA9B0e8B8387', '0x6A3DF51b31A0E87DBae4E1EDE1ffb928D09b9Dc6');
...
const libe2 = await ethers.getContractFactory('LibRegistryAdd');
const toke = await ethers.getContractFactory('RewardDistributor');

let moo = {
  creatorAddress: signer.address,
  info: "Genesis Staking",
  level: 0,
}

let g = await toke.deploy( '0xCB13Ca54A9744aFA2586E6232b94a58cF9B5E25C', moo)
console.log(await g.getAddress())
...
//  const exxclass =  exClass.deploy( '0x6A3DF51b31A0E87DBae4E1EDE1ffb928D09b9Dc6', '0xdB117EE426EA72A4A16Bc1f6a791bA9B0e8B8387', '0x08C3b10Db818cd84E5A718607828CaaA90CD470c', {
//   creatorAddress: signer.address,
//   info: "moo",
//   level: 0,
// })
